            ...
            <div className="container">
                ...
                <div className={`collapse navbar-collapse${menuOpen ? " show" : ""}`} id="main-navbar">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        {/* Remove this Home link to avoid duplication */}
                        {/* <li className="nav-item"><Link to="/" className="nav-link">Home</Link></li> */}
                        <li className="nav-item"><Link to="/specials" className="nav-link">Specials</Link></li>
                        ...
                        <li className="nav-item"><Link to="/quote" className="nav-link">Instant Quote</Link></li>
                    </ul>
